    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/users//get-unregistered-users").hasAnyAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/comments/unapproved-messages").hasAnyAuthority("MODERATOR")
